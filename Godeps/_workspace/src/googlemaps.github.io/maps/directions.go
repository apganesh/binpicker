...
func (r *DirectionsRequest) params() url.Values {
	...
	if r.Mode != "" {
		q.Set("travelmode", string(r.Mode))
	}
	if r.DepartureTime != "" {
...
type Step struct {
	...
	TransitDetails *TransitDetails `json:"-"`
